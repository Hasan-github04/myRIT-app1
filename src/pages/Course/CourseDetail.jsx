...
export default function CourseDetailScreen() {
        ...
        <View style={styles.assignmentsSection}>
          ...
          {courseAssignments.map((assignment) => {
            ...
            const getTypeColor = (type) => {
              switch (type) {
                case "exam":
                  return { bg: "#FEE2E2", text: "#991B1B", label: "Exam" };
                case "project":
                  return { bg: "#DBEAFE", text: "#1E40AF", label: "Project" };
                case "quiz":
                  return { bg: "#FEF3C7", text: "#92400E", label: "Quiz" };
                default:
                  return { bg: "#F3E8FF", text: "#6B21A8", label: "Homework" };
              }
            };
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                if (item.id === "content") {
                  ...
                  console.log(
                    `Maps to ${item.label} for course ${course.code}`
                  );
                }
              }}
            >
    ...
    return (
      ...
      >
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View
            style={[styles.tocHeader, { backgroundColor: colors.background }]}
          >
            ...
            >
              <Text style={[styles.tocBadgeText, { color: colors.primary }]}>
                14
              </Text>
            </View>
          </View>
          ...
          {/* Modules List */}
          <View
            style={[styles.modulesList, { backgroundColor: colors.background }]}
          >
            {moduleData.map((module, index) => {
              ...
              return (
                ...
                >
                  <Text style={[styles.moduleText, { color: colors.text }]}>
                    {module.label}
                  </Text>
          ...
          {expandedModule && (
            <View
              style={[
                styles.expandedModuleContainer,
                { backgroundColor: colors.background },
              ]}
            >
              {/* Header */}
  ...
  const renderClasslist = () => {
    const filteredClasslist = classlistData.filter(
      (student) =>
        student.name.toLowerCase().includes(classlistSearch.toLowerCase()) ||
        student.username.toLowerCase().includes(classlistSearch.toLowerCase())
    );
        ...
        >
          <View style={[styles.searchBar, { borderColor: colors.border }]}>
            <TextInput
              ...
              onChangeText={setClasslistSearch}
            />
            <Search size={20} color={colors.textSecondary} />
          </View>
        </View>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            <View style={styles.clTableContainer}>
              ...
              >
                ...
                >
                  <Text style={[styles.clHeaderText, { color: colors.text }]}>
                    Name
                  </Text>
                  ...
                  <View
                    ...
                    style={[
                      styles.clTableRow,
                      {
                        borderBottomColor: colors.border,
                        backgroundColor:
                          index % 2 === 0 ? colors.background : colors.card,
                      },
                    ]}
                  >
                    ...
                    <Text style={[styles.clColUser, { color: colors.text }]}>
                      {student.username}
                    </Text>
                    <Text style={[styles.clColEmail, { color: colors.text }]}>
                      {student.email}
                    </Text>
                  </View>
                ))}
  ...
  const renderGroups = () => (
    ...
    >
      <View style={styles.grpContainer}>
        {/* Top Button */}
        <TouchableOpacity
          style={[styles.grpHeaderBtn, { backgroundColor: "#006FA3" }]}
        >
        ...
        <View style={[styles.grpTable, { borderColor: colors.border }]}>
          ...
          >
            <View style={[styles.grpCell, { flex: 2 }]}>
              <Text style={[styles.grpHeaderText, { color: colors.text }]}>
                Groups
              </Text>
            </View>
            <View
          ...
          {groupsData.groups.map((g) => (
            <View
              key={g.id}
              style={[styles.grpRow, { borderBottomColor: colors.border }]}
            >
              <View style={[styles.grpCell, { flex: 2 }]}>
                <Text style={{ color: "#006FA3", fontWeight: "500" }}>
                  {g.name}
                </Text>
              </View>
              <View
        ...
        >
          ...
          >
            <View style={[styles.assignCell, { flex: 3 }]}>
              <Text style={[styles.assignHeaderText, { color: colors.text }]}>
                Assignment
              </Text>
            </View>
            <View
          ...
          >
            <Text style={[styles.assignSubHeaderText, { color: colors.text }]}>
          ...
          {homeworkData.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <TouchableOpacity>
                    <Text style={styles.assignTitle}>
                      {item.title} <UsersRound size={14} color={colors.text} />{" "}
                      <Printer size={14} color={colors.text} />
                    </Text>
                  </TouchableOpacity>

                  <Text style={[styles.assignDue, { color: colors.text }]}>
                    Due on {item.dueDate}
                  </Text>
                ...
                >
                  <Text style={[styles.assignScore, { color: colors.text }]}>
                    {item.score}
                  </Text>
                </View>
              </View>
    ...
    >
      <View style={styles.grpContainer}>
        ...
        <View style={styles.finalGradeContainer}>
          <Text style={[styles.finalGradeTitle, { color: colors.text }]}>
            Final Calculated Grade
          </Text>

          <View style={{ marginTop: 12 }}>
            <Text style={[styles.finalGradeSubtitle, { color: colors.text }]}>
              Weight Achieved
            </Text>
            <View style={styles.finalGradeValueRow}>
              <Text style={[styles.finalGradeValue, { color: colors.text }]}>
                {gradesData.final.weightAchieved}
              </Text>
              <Calculator
                size={18}
                color={colors.text}
        ...
        >
          ...
          >
            <View style={[styles.gradesCell, { flex: 2.5 }]}>
              <Text style={[styles.gradesHeaderText, { color: colors.text }]}>
                Grade Item
              </Text>
            </View>
            ...
            return (
              ...
              >
                ...
                <View
                  style={[
                    styles.gradesCell,
                    { flex: 2.5, paddingLeft: isCategory ? 16 : 32 },
                  ]}
                >
                  <Text
                    style={{
        ...
        <View style={styles.grpContainer}>
          ...
          <View style={styles.attendContainer}>
            <View style={{ marginBottom: 20 }}>
              <Text style={[styles.attendLabel, { color: colors.text }]}>
                % Attendance:
              </Text>
              <Text style={[styles.attendValue, { color: colors.text }]}>
            ...
            <View style={{ marginBottom: 20 }}>
              ...
              <Text style={[styles.attendSummary, { color: colors.text }]}>
